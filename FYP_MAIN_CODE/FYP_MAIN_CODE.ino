...
#define API_KEY "xxxxxx"                 // Insert Firebase project API Key
#define DATABASE_URL "xxxxxxx"  // Insert RTDB URLefine the RTDB URL
...
void loop() {
  ...
  if (millis() - tsLastReport1 > REPORTING_PERIOD_MS1) {
    ...
    char Mymessage1[10];
    dtostrf(BPM, 3, 0, Mymessage1);
    Serial2.write(Mymessage1, 5);  //Write the serial data
    delay(500);
